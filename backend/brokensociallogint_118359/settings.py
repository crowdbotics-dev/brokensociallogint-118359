"""
Django settings for brokensociallogint_118359 project.
...
ROOT_URLCONF = 'brokensociallogint_118359.urls'
...
WSGI_APPLICATION = 'brokensociallogint_118359.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "brokensociallogint_118359 API",
    "DESCRIPTION": "API documentation for brokensociallogint_118359 App",
    "VERSION": "v1",
}
