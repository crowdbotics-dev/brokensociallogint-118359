...
## Project Structure
    ...
    ├── brokensociallogint_118359  # Django project configurations
...
1. Clone this repo and `cd brokensociallogint_118359`
...
2. Clone this repo and `cd brokensociallogint_118359`
